    ...
    def calculate(
        ...
        if current_liabilities > 0:
            ...
            ratios.append(
                Ratio(
                    "Liquidez Corrente",
                    round(lc, 2),
                    self._status(lc, Decimal("1.5"), Decimal("1.0")),
            ...
            ratios.append(
                Ratio(
                    "Liquidez Seca",
                    round(ls, 2),
                    self._status(ls, Decimal("1.0"), Decimal("0.8")),
            ...
            ratios.append(
                Ratio(
                    "Liquidez Imediata",
                    round(li, 2),
                    self._status(li, Decimal("0.5"), Decimal("0.2")),
        ...
        if interest_expense > 0:
            ...
            ratios.append(
                Ratio(
                    "Cobertura de Juros",
                    round(ic, 2),
                    self._status(ic, Decimal("3"), Decimal("1.5")),
        ...
        ratios.append(
            Ratio(
                "DSCR",
                round(dscr, 2),
                self._status(dscr, Decimal("1.25"), Decimal("1.0")),
        ...
        if total_assets > 0:
            ...
            z = (
                Decimal("0.717") * wc_ta
                + Decimal("0.847") * re_ta
                + Decimal("3.107") * ebit_ta
                + Decimal("0.420") * equity_debt
        ...
        if total_assets > 0:
            ...
            ratios.append(
                Ratio(
                    "ROA (aprox)",
                    round(roa, 2),
                    self._status(roa, Decimal("0.08"), Decimal("0.03")),
        ...
        if equity > 0:
            ...
            ratios.append(
                Ratio(
                    "ROE (aprox)",
                    round(roe, 2),
                    self._status(roe, Decimal("0.15"), Decimal("0.08")),
        ...
        if sales > 0:
            net_income_proxy = ebit * Decimal("0.65")  # simplified post-tax proxy
            net_margin = net_income_proxy / sales
            ratios.append(
                Ratio(
                    "Margem Líquida",
                    round(net_margin, 2),
                    self._status(net_margin, Decimal("0.10"), Decimal("0.04")),
                    "Lucro Líquido (aprox.) / Receita. Rentabilidade final após impostos.",
                )
            )
